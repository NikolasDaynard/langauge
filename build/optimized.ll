...
entry:
  %0 = tail call i32 (...) @printf(ptr nonnull @constStr, double 1.000000e+00)
  %1 = tail call i32 (...) @printf(ptr nonnull @constStr.1, double 1.000000e+00, double 2.000000e+00)
  ret i32 0
}
...
main:
  ...
  %3 = tail call i32 (...) @printf(ptr nonnull @constStr.1, double %0, double %1)
  ret i32 0
}
